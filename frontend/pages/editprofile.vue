      ...
      <v-row class="justify-center align-center">
        ...
        <v-col cols="6" sm="4">
          <v-card flat>
            ...
            <v-text-field outlined justify="center" v-model="form.firstname" label="First Name"></v-text-field>
        ...
        <v-col cols="6" sm="4">
          <v-card flat>
            ...
            <v-text-field
              ...
              label="Location (city)"
            ></v-text-field>
            <v-select outlined v-model="form.union" :items="unions" label="Union Status"></v-select>
          </v-card>
        </v-col>
      ...
      <v-row>
        ...
        <v-col sm="6">
          <v-card class="ml-sm-n4" flat>
            <v-card-title>{{ form.profession }}</v-card-title>
            <v-card-subtitle>{{ form.firstname }}{{ form.lastname }}</v-card-subtitle>
            <v-text-field
              outlined
              justify="center"
        ...
        <v-col sm="10">
          <v-textarea class="ml-sm-16" label="bio" outlined v-model="form.bio" color="teal">
        ...
        <v-col sm="6">
          ...
          <v-checkbox
            ...
            value="Experimental"
          ></v-checkbox>
          <v-checkbox v-model="form.project_types" label="Feature" color="brown" value="Feature"></v-checkbox>
          <v-checkbox
            v-model="form.project_types"
            label="Music Video"
            color="brown"
            value="Music Video"
          ></v-checkbox>
          <v-checkbox v-model="form.project_types" label="Short" color="brown" value="Short"></v-checkbox>
        </v-col>
        <v-col sm="6">
          <v-checkbox v-model="form.project_types" label="Student" color="brown" value="Student"></v-checkbox>
          <v-checkbox
            v-model="form.project_types"
            label="Television"
            color="brown"
          ...
          <v-checkbox
            ...
            value="Web / New Media"
          ></v-checkbox>
          <v-checkbox v-model="form.project_types" label="Theater" color="brown" value="Theater"></v-checkbox>
        </v-col>
        <v-col sm="10">
          <v-card flat>
        ...
        <v-col sm="4">
          ...
          <v-text-field
            ...
            v-model="form.Instagram_Handle_if_applicable"
            label="Instagram"
          ></v-text-field>
        </v-col>
        <v-col sm="4">
  ...
  data() {
    return {
      ...
      form: {
        ...
        twitter: null,
        linkedIn: null,
        Instagram_Handle_if_applicable: null,
        youtube_or_vimeo: null
      }
    };
  }
};
